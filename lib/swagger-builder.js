...
Handlebars.registerHelper('compare-helper', (object) => {
  let ret = ''
  if (object.in === 'query') {
    ret = `    params.querys.append('` + object.name + `', parameters['` + object.name + `'])`
  }
  if (object.in === 'header') {
    ret = `    params.headers.append('` + object.name + `', parameters['` + object.name + `'])`
  }
  if (object.in === 'body') {
...
Handlebars.registerHelper('url-compare-helper', (object) => {
  let ret = ''
  if (object.in === 'query') {
    ret = `  querys.append('` + object.name + `', parameters['` + object.name + `'])`
  }
  if (object.in === 'header') {
